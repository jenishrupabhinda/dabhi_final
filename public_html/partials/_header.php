...
$isAdminUser = $isLoggedIn && in_array($userRole, ['superadmin', 'admin', 'employee'], true);
...
<head>
  ...
  <style>
    ...
    /* User & Admin Profile Dropdown (Right-aligned) */
    ...
    .profile-dropdown-wrap:focus-within .profile-dropdown-menu {
      opacity: 1 !important;
      visibility: visible !important;
      pointer-events: auto !important;
          ...
          <?php if ($isLoggedIn): ?>
            ...
            <div class="profile-dropdown-wrap">
              ...
              <div class="profile-dropdown-menu">
                <div class="nav-dropdown-card" style="width: 260px !important;">
                  <?php if ($isAdminUser): ?>
                    <div class="nav-dropdown-header">
                      <span>⚡ <?= htmlspecialchars(ucfirst($userRole ?? 'Admin')) ?></span>
                      <span style="color:#f6dc94;"><?= htmlspecialchars(explode(' ', $currentUser['full_name'] ?? 'Admin')[0]) ?></span>
                    </div>
                    <div style="display:flex;flex-direction:column;gap:3px;">
                      <a href="admin/index.php" class="nav-dropdown-item">
                        <div style="display:flex;align-items:center;gap:10px;">
                          <span style="font-size:1.1rem;">📊</span>
                          <div>
                            <div class="nav-item-title" style="color:#f6dc94 !important;">Admin Dashboard</div>
                            <div class="nav-item-sub">Manage store &amp; orders</div>
                          </div>
                        </div>
                        <span class="nav-item-badge" style="background:#c7613d;color:#fff;">Admin</span>
                      </a>
                      <a href="account.php" class="nav-dropdown-item">
                        <div style="display:flex;align-items:center;gap:10px;">
                          <span style="font-size:1.1rem;">🛍️</span>
                          <div>
                            <div class="nav-item-title">Customer View</div>
                            <div class="nav-item-sub">Storefront profile</div>
                          </div>
                        </div>
                      </a>
                      <a href="logout.php" class="nav-dropdown-item" style="border-top:1px solid rgba(255,255,255,0.08);margin-top:4px;padding-top:8px;">
                        <div style="display:flex;align-items:center;gap:10px;">
                          <span style="font-size:1.1rem;">🚪</span>
                          <div class="nav-item-title" style="color:#f87171 !important;">Sign Out</div>
                        </div>
                      </a>
                    </div>
                  <?php else: ?>
                    <div class="nav-dropdown-header">
                      <span>👤 Customer</span>
                      <span style="color:#f6dc94;"><?= htmlspecialchars(explode(' ', $currentUser['full_name'] ?? 'Account')[0]) ?></span>
                    </div>
                    <div style="display:flex;flex-direction:column;gap:3px;">
                      <a href="account.php" class="nav-dropdown-item">
                        <div style="display:flex;align-items:center;gap:10px;">
                          ...
                          <div>
                            ...
                            <div class="nav-item-sub">Profile &amp; addresses</div>
                          </div>
                        </div>
                      </a>
                      <a href="account.php?section=orders" class="nav-dropdown-item">
                        <div style="display:flex;align-items:center;gap:10px;">
                          <span style="font-size:1.1rem;">📦</span>
                          <div>
                            <div class="nav-item-title">My Orders</div>
                            <div class="nav-item-sub">Track past purchases</div>
                          </div>
                        </div>
                      </a>
                      <a href="logout.php" class="nav-dropdown-item" style="border-top:1px solid rgba(255,255,255,0.08);margin-top:4px;padding-top:8px;">
